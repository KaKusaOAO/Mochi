...
public static class Preconditions
{
    ...
    public static void NotNull(object? obj, string name) => InternalEnsure(obj != null, $"{name} cannot be null.");
    ...
    private static void InternalEnsure(bool test, string message)
    {
        if(!test)
        {
