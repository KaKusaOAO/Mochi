...
public class CommandSyntaxException : Exception {
    ...
    public CommandSyntaxException(ICommandExceptionType type, IMessage message, string input, int cursor) : base(message.GetString()) {
        this._type = type;
        this._message = message;
        this._input = input;
        this._cursor = cursor;
    ...
    public ICommandExceptionType GetType() {
        return _type;
    }
