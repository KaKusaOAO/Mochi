...
public class StringArgumentType : IArgumentType<string> {
    ...
    public class StringType {
        public static readonly StringType SINGLE_WORD = new("word", "words_with_underscores");
        public static readonly StringType QUOTABLE_PHRASE = new("\"quoted phrase\"", "word", "\"\"");
        public static readonly StringType GREEDY_PHRASE = new("word", "words with spaces", "\"and symbols\"");
